...
public class MainActivity$$ViewInjector {
  public static void inject(Finder finder, final ui.MainActivity target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131558454, "field 'mCaloriesLabel'");
    target.mCaloriesLabel = (android.widget.TextView) view;
    view = finder.findRequiredView(source, 2131558455, "field 'mPbCalories'");
    target.mPbCalories = (android.widget.ProgressBar) view;
    view = finder.findRequiredView(source, 2131558449, "field 'mCaloriesContainer'");
    ...
    view = finder.findRequiredView(source, 2131558458, "field 'mDrawerList'");
    target.mDrawerList = (android.widget.ListView) view;
    view = finder.findRequiredView(source, 2131558456, "field 'mStepsTakenLabel'");
    target.mStepsTakenLabel = (android.widget.TextView) view;
    view = finder.findRequiredView(source, 2131558457, "field 'mStepProgressLabel'");
    target.mStepProgressLabel = (android.widget.TextView) view;
    view = finder.findRequiredView(source, 2131558451, "field 'mCalNotSetLabel'");
