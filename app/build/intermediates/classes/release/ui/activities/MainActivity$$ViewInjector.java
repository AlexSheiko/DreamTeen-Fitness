...
public class MainActivity$$ViewInjector {
  public static void inject(Finder finder, final ui.activities.MainActivity target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131558452, "field 'mProgressBar'");
    ...
    view = finder.findRequiredView(source, 2131558455, "field 'mDrawerList'");
    target.mDrawerList = (android.widget.ListView) view;
    view = finder.findRequiredView(source, 2131558453, "field 'mStepsLabel'");
    target.mStepsLabel = (android.widget.TextView) view;
    view = finder.findRequiredView(source, 2131558454, "field 'mStepsTargetLabel'");
