...
public class RunGoalDialog extends DialogFragment {
                ...
                .setPositiveButton("Set", new OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        if (!mValueField.getText().toString().isEmpty()) {
                            ...
                            if (key.equals("calories")) {
                                mListener.onCaloriesGoalChanged(RunGoalDialog.this, newValue);
                            } else if (key.equals("steps")) {
                                mListener.onStepsGoalChanged(RunGoalDialog.this, newValue);
                            }
                        }
                        RunGoalDialog.this.getDialog().cancel();
                    }
                });
