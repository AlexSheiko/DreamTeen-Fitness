                ...
                .setPositiveButton("Set", new OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        if (!mValueField.getText().toString().isEmpty()) {
                            ...
                            if (key.equals("calories")) {
                                mListener.onCaloriesGoalChanged(SetGoalDialog.this, newValue);
                            } else if (key.equals("steps")) {
                                mListener.onStepsGoalChanged(SetGoalDialog.this, newValue);
                            }
                        }
                        SetGoalDialog.this.getDialog().cancel();
                    }
                });
