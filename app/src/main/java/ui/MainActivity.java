...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Parse.initialize(this, "TEKnXhDk2WsSfRcucPtYjdvrwt0CvIbsaSV3VaXu", "sjUMSiS0evbfopwjSBYpVPTJf4GV4Wr0BNzH6Jf0");
    ...
    private void buildFitnessClient() {
        mClient = new GoogleApiClient.Builder(this)
                .addApi(Fitness.API).addScope(Fitness.SCOPE_ACTIVITY_READ_WRITE)
                .addApi(Fitness.API).addScope(Fitness.SCOPE_LOCATION_READ)
